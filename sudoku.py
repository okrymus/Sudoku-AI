class Sudoku(object):
    ...
    def __init__(self, puzzle):
        ...
        self.board is a list of lists representation of the board using ints - Update this board with new moves
    ...
    def overwritten(self):
        """
        Tests whether one of the original tiles was overwritten. Should NOT
